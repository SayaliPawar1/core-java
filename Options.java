...
public class Options extends Account {
	...
	public void getLogin() throws IOException {
		...
		do {
			try {
				 ...
				 * number
				 */
				data.put(999999999, 1234);
				data.put(123456780, 1230);
				data.put(001100110, 0026);

				System.out.println("Welcome to the Pawar's Project!");
			...
			System.out.println("\n" + "haha Wrong Customer Number or Pin Number." + "\n");
		} while (x == 1);
	}
	...
	public void getAccountType() {
		...
		case 3:
			System.out.println("Thanks for using this project mate, bye.");
			break;
